...
const ParameterSensor = () => {
  ...
  useEffect(() => {
    ...
    const fetchDataApi = async () => {
      const url = `/Admin/HydraulicDetails/GetAllHydraulicDetails`;
  ...
  const searchColumns = ["performedBy", "stationID"];
  ...
  const handleDeleteRole = async (reason, record) => {
    ...
    apiCaller({
      ...
      apiCall: () =>
        api.post(
          "/Admin/HydraulicDetails/ActiveDeactiveHydraulicDetails",
          formData,
        ),
      onSuccess: () => {
